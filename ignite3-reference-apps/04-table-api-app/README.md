...
1. **Explore SQL API**: Learn when SQL excels over Table API
   - File: `../05-sql-api-app/`
   - Documentation: `../../docs/05-sql-api-relational-data-access.md`

2. **Master Transactions**: Understand distributed ACID guarantees
   - File: `../06-transactions-app/`
   - Documentation: `../../docs/06-transactions.md`
...
- **Documentation**: `../../docs/04-table-api-object-oriented-data-access.md`
