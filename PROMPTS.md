...
GOAL: Teach developers how to use [specific interface] effectively in Ignite 3. This is a Java API primer, not a [concept] theory guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to use the Transaction interface, not transaction theory. This is a Java API primer, not a transaction concepts guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
- Avoid: Provide context about ACID theory but do not go deep, transaction isolation concepts unrelated to API usage
...
GOAL: Teach developers how to use compute interfaces for distributed job execution, not distributed computing theory. This is a Java API primer, not a compute concepts guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to use streaming interfaces for bulk data operations, not data streaming theory. This is a Java API primer, not a streaming concepts guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to implement caching patterns using Ignite 3 Java APIs, not caching theory. This is a Java API primer, not a caching concepts guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
Please review how caching patterns are implemented using Ignite 3 Java APIs and create both documentation and reference applications demonstrating cache-aside, write-through, and write-behind patterns with the music store dataset, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to use schema management interfaces for catalog operations, not database schema theory. This is a Java API primer, not a schema design guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to use Java APIs for complex scenarios like error handling, retry patterns, and performance monitoring, not advanced distributed systems theory. This is a Java API primer, not an advanced concepts guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to integrate Ignite 3 Java APIs with Spring, microservices, and JPA, not integration architecture theory. This is a Java API primer, not an integration patterns guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers common Java API usage patterns and implementations, not best practices theory. This is a Java API primer, not a best practices guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
...
GOAL: Teach developers how to use Java APIs for diagnostics and troubleshooting, not troubleshooting methodology. This is a Java API primer, not a troubleshooting theory guide, the writing should tell a story and contain educational content that progressively develops the general concepts for each section.
